...
if not st.sidebar.checkbox("Toggle Display", False):
...
if not st.sidebar.checkbox("Toggle Display", False, key="1"):
...
if not st.sidebar.checkbox("Toggle Display", False, key="3"):
